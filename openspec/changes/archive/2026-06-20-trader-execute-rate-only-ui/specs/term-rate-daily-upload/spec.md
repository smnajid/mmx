...
#### Scenario: Execute form proposed rate is not rate management UI

- **WHEN** the trader opens the execute form on an order detail screen
- **THEN** the screen does not expose term rate upload, day browser, or review tree — at most one pre-filled proposed rate for the intake institution
