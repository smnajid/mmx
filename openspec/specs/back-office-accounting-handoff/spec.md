# back-office-accounting-handoff Specification

## Purpose

`EXECUTED` → `ACCOUNTED` lifecycle, outbound execution notification after commit, inbound accounted callback contract, idempotency, and POC callback authentication posture.
