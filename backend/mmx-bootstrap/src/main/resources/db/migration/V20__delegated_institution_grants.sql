...
-- Proxy institutions reference the hub native institution; natives keep NULL hub columns.
...
-- Hub-owned reference data scoped to LegalEntity (default hub LOC for existing rows).
